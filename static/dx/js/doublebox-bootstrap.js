(function($, window, document, undefined) {
	...
	BootstrapDualListbox.prototype = {
		init: function() {
			this.container = $("" + '<div class="bootstrap-duallistbox-container" style="display:flex;display:-webkit-flex;align-items:center;justify-content:center;">' + ' <div class="box1" >' + "   <label></label>" + '   <span class="info-container">' + '     <span class="info"></span>' + '     <button type="button" class="btn clear1 pull-right"></button>' + "   </span>" + '   <input class="filter form-control ue-form" type="text">' + '   <select multiple="multiple" style="overflow:scroll;"></select>' + " </div>" + ' <div class="btn-box">' + '     <button type="button" class="btn db-btn move">' + "       <i></i>" + "     </button>" + '     <button type="button" class="btn db-btn moveall">' + "       <i></i>" + "       <i></i>" + "     </button>" + '     <p class="clearfix" style="margin-bottom:20px"></p>' + '     <button type="button" class="btn db-btn remove">' + "       <i></i>" + "     </button>" + '     <button type="button" class="btn db-btn removeall">' + "       <i></i>" + "       <i></i>" + "     </button>" + " </div>" + ' <div class="box2">' + "   <label></label>" + '   <span class="info-container">' + '     <span class="info"></span>' + '     <button type="button" class="btn clear2 pull-right"></button>' + "   </span>" + '   <input class="filter form-control ue-form" type="text">' + '   <select multiple="multiple" style="overflow:scroll;"></select>' + " </div>" + "</div>").insertBefore(this.element);
			this.elements = {
		...
		setBootstrap2Compatible: function(value, refresh) {
			...
			if (value) {
				...
				this.container.find(".moveall > i, .move > i").removeClass("icon-arrow-right").addClass("glyphicon glyphicon-arrow-right").css('color', '#696969');
				this.container.find(".removeall > i, .remove > i").removeClass("icon-arrow-left").addClass("glyphicon glyphicon-arrow-left").css('color', '#696969');
...
function(window, $, undefined) {
	$.fn.doublebox = function(options) {
		...
		box.getNonSelectedOptions = function() {
			var items = $("#bootstrap-duallistbox-nonselected-list_doublebox>option").map(function() {
				return $(this).val()
			}).get().join(",");
			return items
		};
